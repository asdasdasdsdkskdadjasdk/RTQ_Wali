      ...
      <div class="chart-container">
        ...
        <div class="p-4">
          <div class="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 gap-3">
            <button
              onclick="window.location.href='<?php echo e(route('yayasan.hafalansantriY.detail', ['cabang' => 'Sukajadi'])); ?>'"
              class="bg-[#A4E4B3] text-black font-semibold py-2 rounded shadow hover:bg-green-200 transition">Sukajadi</button>

            <button
              onclick="window.location.href='<?php echo e(route('yayasan.hafalansantriY.detail', ['cabang' => 'Rumbai'])); ?>'"
              class="bg-[#A4E4B3] text-black font-semibold py-2 rounded shadow hover:bg-green-200 transition">Rumbai</button>

            <button
              onclick="window.location.href='<?php echo e(route('yayasan.hafalansantriY.detail', ['cabang' => 'Gobah 1'])); ?>'"
              class="bg-[#A4E4B3] text-black font-semibold py-2 rounded shadow hover:bg-green-200 transition">Gobah
              1</button>

            <button
              onclick="window.location.href='<?php echo e(route('yayasan.hafalansantriY.detail', ['cabang' => 'Gobah 2'])); ?>'"
              class="bg-[#A4E4B3] text-black font-semibold py-2 rounded shadow hover:bg-green-200 transition">Gobah
              2</button>
