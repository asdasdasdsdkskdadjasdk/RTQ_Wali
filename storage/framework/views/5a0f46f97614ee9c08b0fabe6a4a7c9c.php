...
<body>
  <div class="container flex">
    ...
    <div class="gy-sidebar" id="sidebar">
      ...
      <a href="<?php echo e(route('guru.profile.edit')); ?>" class="active">
    ...
    <?php endif; ?>
        ...
        <div class="bg-white rounded-xl shadow p-4">
          <form action="<?php echo e(route('guru.profile.update')); ?>" method="POST">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
              <div>
                ...
                <input type="text" class="w-full border rounded px-3 py-2 bg-gray-100" value="<?php echo e($guru->nama_guru); ?>"
                  readonly>
              </div>
              <div>
                <label class="block text-sm font-semibold mb-1">Email</label>
                <input type="text" class="w-full border rounded px-3 py-2 bg-gray-100" value="<?php echo e($guru->email); ?>"
                  readonly>
              </div>
            </div>
            ...
            <option value="<?php echo e($p); ?>" <?php echo e(old('pend_akhir', $guru->pend_akhir) == $p ? 'selected' : ''); ?>><?php echo e($p); ?>
          ...
          <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            ...
            <option value="<?php echo e($s); ?>" <?php echo e(old('status_menikah', $guru->status_menikah) == $s ? 'selected' : ''); ?>>
            <?php echo e($s); ?></option>
          <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                </select>
              </div>
...
</html><?php /**PATH C:\laragon\www\SistemFinalPA_180825\Sistem\sistemrtq\resources\views/guru/profile/edit.blade.php ENDPATH**/ ?>