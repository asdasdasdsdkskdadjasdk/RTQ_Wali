  ...
  <div class="container">
    ...
    <div class="sidebar" style="display: flex; flex-direction: column; height: 100vh; justify-content: space-between;">
      ...
      <div style="flex: 1; overflow-y: auto;">
        ...
        <a href="<?php echo e(route('admin.hafalanadmin.index')); ?>" class="active"><i class="fas fa-book" style="margin-right:8px;"></i>Hafalan
          Santri</a>
...
</html><?php /**PATH D:\Adel\Semester 8\TA Adel\Sistem\sistemrtq\resources\views/admin/hafalanadmin/index.blade.php ENDPATH**/ ?>