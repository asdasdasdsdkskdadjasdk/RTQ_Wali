          ...
          <div style="display: grid; grid-template-columns: 1fr 1fr 1fr; gap: 0.5rem 1rem;">
            ...
            <?php $__currentLoopData = $fields; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $f): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
              <div style="display: flex; flex-direction: column;">
                ...
                <input type="<?php echo e($f[2] ?? 'text'); ?>" name="<?php echo e($f[0]); ?>" id="<?php echo e($f[0]); ?>"
                  placeholder="Masukan <?php echo e($f[1]); ?>"
            ...
            <div style="display: flex; flex-direction: column;">
              ...
              <select name="GolDar" id="GolDar" required>
                <option value="" disabled <?php echo e(old('GolDar', $santri->GolDar) ? '' : 'selected'); ?>>Masukan Golongan Darah</option>
            ...
            <div style="display: flex; flex-direction: column;">
              ...
              <select name="jenis_kelamin" id="jenis_kelamin" required>
                <option value="" disabled <?php echo e(old('jenis_kelamin', $santri->jenis_kelamin) ? '' : 'selected'); ?>>Masukan Jenis Kelamin</option>
            ...
            <div style="display: flex; flex-direction: column;">
              ...
              <select name="kat_masuk" id="kat_masuk" required>
                <option value="" disabled <?php echo e(old('kat_masuk', $santri->kat_masuk) ? '' : 'selected'); ?>>Masukan Kategori Masuk</option>
                <option value="Umum" <?php echo e(old('kat_masuk', $santri->kat_masuk) == 'Umum' ? 'selected' : ''); ?>>Umum</option>
                <option value="Beasiswa" <?php echo e(old('kat_masuk', $santri->kat_masuk) == 'Beasiswa' ? 'selected' : ''); ?>>Beasiswa</option>
              </select>
            </div>
            ...
            <div style="display: flex; flex-direction: column;">
              ...
              <select name="kelas" id="kelas" required>
                ...
                <?php $__currentLoopData = ['Halaqah A','Halaqah B','Halaqah C','Halaqah D','Halaqah E']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $kls): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                  <option value="<?php echo e($kls); ?>" <?php echo e(old('kelas', $santri->kelas) == $kls ? 'selected' : ''); ?>><?php echo e($kls); ?></option>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
              </select>
            </div>
            ...
            <div style="display: flex; flex-direction: column;">
              ...
              <select name="periode_id" id="periode" required>
                <option value="" disabled <?php echo e(old('periode_id', $santri->periode_id) ? '' : 'selected'); ?>>Pilih Periode</option>
            ...
            <div style="display: flex; flex-direction: column;">
              ...
              <select name="jenis_kelas" id="jenis_kelas" required>
                <option value="" disabled <?php echo e(old('jenis_kelas', $santri->jenis_kelas) ? '' : 'selected'); ?>>Jenis Kelas</option>
                <option value="1 Tahun" <?php echo e(old('jenis_kelas', $santri->jenis_kelas) == '1 Tahun' ? 'selected' : ''); ?>>1 Tahun</option>
                <option value="2 Tahun" <?php echo e(old('jenis_kelas', $santri->jenis_kelas) == '2 Tahun' ? 'selected' : ''); ?>>2 Tahun</option>
              </select>
            </div>
...
<?php /**PATH D:\Adel\Semester 8\TA Adel\Sistem\sistemrtq\resources\views/admin/datasantri/edit.blade.php ENDPATH**/ ?>