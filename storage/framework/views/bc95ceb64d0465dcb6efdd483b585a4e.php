...
<div class="container">
    ...
    <div class="main">
        ...
        <div class="chart-container">
            <form id="filterForm" method="GET" action="<?php echo e(route('admin.datasantri.history')); ?>" class="table-controls"
                ...
                <div style="display:flex; gap:.5rem; align-items:center; flex-wrap:wrap;">
                    <select name="periode" id="periode" onchange="document.getElementById('filterForm').submit()"
                        ...
                        <option value="all" <?php echo e(($periodeSelected ?? 'all') === 'all' ? 'selected' : ''); ?>>Semua Periode</option>
            ...
            <?php if($santris->hasPages()): ?>
                <div class="box-pagination-left">
                    ...
                    <?php else: ?>
                        <a href="<?php echo e($santris->appends(request()->query())->previousPageUrl()); ?>" class="page-box-small">«</a>
                    <?php endif; ?>
...
<?php /**PATH D:\Sistem\sistemrtq\resources\views/admin/datasantri/history.blade.php ENDPATH**/ ?>