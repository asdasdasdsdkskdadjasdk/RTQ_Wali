                ...
                <tr>
                  ...
                  <td class="action-buttons">
                    ...
                    <a href="<?php echo e(route('admin.datasantri.show', $santri->id)); ?>">
                      <button class="detail"><img src="<?php echo e(asset('img/image/detail.png')); ?>" alt="detail" height="20" /></button>
                    </a>
                    <form action="<?php echo e(route('admin.datasantri.destroy', $santri->id)); ?>"
                          method="POST"
                          onsubmit="return confirm('Apakah Anda yakin ingin menghapus data ini?');"
                          style="display:inline;">
                      <?php echo csrf_field(); ?>
                      <?php echo method_field('DELETE'); ?>
                      <button class="delete"><img src="<?php echo e(asset('img/image/delete.png')); ?>" alt="delete" height="20" /></button>
                    </form>
                  </td>
                </tr>
...
<?php /**PATH D:\Sistem\sistemrtq\resources\views/admin/datasantri/index.blade.php ENDPATH**/ ?>